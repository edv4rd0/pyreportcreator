...
import CustomCellEditors as custcell
#---------------------------------------------------------------------------
...
class QueryGridTable(gridlib.PyGridTableBase):
    def __init__(self, log):
        gridlib.PyGridTableBase.__init__(self)
        self.log = log

        self.colLabels = ['Column', 'Type', 'Include in Results?', 'Priority', 'Platform',
                          'Opened?', 'Fixed?', 'Tested?', 'TestFloat', 'Date']
